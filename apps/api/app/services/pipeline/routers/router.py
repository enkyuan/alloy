"""Pipeline router for classifying command-like and conversational utterances."""
...
class RouteDecision:
    """Decision returned by the pipeline router."""
...
class PipelineRouter:
    """Classifies whether an utterance should go to command parsing or chat flow."""
    ...
    def decide(self, text: str) -> RouteDecision:
        """Decide whether text should enter command fast-path parsing."""
