...
wait_for_service() {
    ...
    if [ "$service_name" = "supabase-db" ]; then
        ...
        echo -e "  3. Run ${GREEN}./apps/cli/scripts/setup.sh${NC} to regenerate configuration"
...
start_all_services() {
    ...
    if [ ! -f ".env" ]; then
        ...
        echo -e "${YELLOW}Run ./apps/cli/scripts/setup.sh to configure your environment.${NC}"
