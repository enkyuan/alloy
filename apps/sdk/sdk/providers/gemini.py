...
from sdk.providers.registry import register_provider
from sdk.providers.types import (
    GenerateResponse,
    ModelMetadata,
    ModelResponseChunk,
    TokenMetrics,
...
class GeminiProvider(ModelProvider):
    ...
    async def generate(
        ...
        from sdk.tools.function_calls import extract_response_function_calls
