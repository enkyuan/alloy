      ...
      <AnimatePresence>
        {isOpen && (
          <m.div
            ...
            className={`absolute top-[calc(100%-1px)] -right-px z-50 w-[480px] max-w-[calc(100vw-2rem)] border-x border-b ${dropdownBorderClass} bg-background shadow-2xl shadow-black/20 dark:shadow-black/60`}
          >
