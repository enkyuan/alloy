    ...
    init() {
        if let clientID = Bundle.main.object(forInfoDictionaryKey: "GIDClientID") as? String {
            ...
            if let serverID = serverClientID, !serverID.isEmpty {
                print("Google Sign-In configured with client ID: \(clientID) and server ID: \(serverID)")
        ...
        WindowGroup {
            ContentView()
                ...
                .onOpenURL { url in
                    ...
                    if url.scheme == "milo" {
                        if url.host == "spotify" || url.host == "gmail" || url.host == "discord" || url.host == "todoist" || url.host == "calendly" {
