...
Installed by `agentkit add github`. Edit freely; this file is yours to own
...
class GitHub(agentkit.Integration):
    ...
    async def get_repo(self, ctx: agentkit.ToolContext, args: dict) -> dict:
    ...
    async def list_issues(self, ctx: agentkit.ToolContext, args: dict) -> dict:
        params = {
    ...
    async def get_pull_request(self, ctx: agentkit.ToolContext, args: dict) -> dict:
    ...
    async def search_repos(self, ctx: agentkit.ToolContext, args: dict) -> dict:
        params = {
            "q": args["query"],
