...
from agentkit.providers.errors import ProviderConfigError
...
def _ensure_builtin_providers_loaded() -> None:
    ...
    importlib.import_module("agentkit.providers.gemini")
    importlib.import_module("agentkit.providers.kimi")
