...
|---|---|---|
| `kaji` (TS) | Beta candidate | Core agent loop, tools, policy, OpenAI/Anthropic providers + OpenRouter/Kimi/Gemini factories (OpenAI-compatible), CI green. Deferred: RAG, voice, Redis, CLI. |
