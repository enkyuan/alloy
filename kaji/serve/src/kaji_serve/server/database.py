...
def __getattr__(name: str) -> Any:
    ...
    # importers can use module attributes without building the engine at import
    # time. Note: this does NOT fire for references *within this module* —
    # internal code must call the factories directly.
