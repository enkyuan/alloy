...
os.environ.setdefault(
    "DATABASE_URL",
    "postgresql+asyncpg://postgres:postgres@localhost:5432/kaji_test_db",
)
...
def mock_supabase_auth():
    ...
    with patch("kaji_serve.server.v1.auth.supabase_auth_service", mock_svc):
        yield mock_svc
