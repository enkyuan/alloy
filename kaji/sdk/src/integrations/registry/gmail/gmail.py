...
Installed by `kaji add gmail`. See SETUP.md (next to this file) for
...
consent flow in your browser; tokens persist to ``~/.kaji/gmail.json``
by default.
"""
...
import kaji
from kaji.integrations.oauth import GoogleOAuthClient
...
class Gmail(kaji.Integration):
    ...
    def __init__(
        ...
        *,
        ...
        path = token_path or Path.home() / ".kaji" / "gmail.json"
    ...
    async def list_messages(self, ctx: kaji.ToolContext, args: dict) -> dict:
        params: dict[str, Any] = {
    ...
    async def get_message(self, ctx: kaji.ToolContext, args: dict) -> dict:
