...
Installed by `kaji add gcal`. See SETUP.md (next to this file) for
...
class GoogleCalendar(kaji.Integration):
    ...
    def __init__(
        ...
        *,
        ...
        path = token_path or Path.home() / ".kaji" / "gcal.json"
    ...
    async def list_events(self, ctx: kaji.ToolContext, args: dict) -> dict:
        params: dict[str, Any] = {
    ...
    async def get_event(self, ctx: kaji.ToolContext, args: dict) -> dict:
        cal_id = args.get("calendar_id", "primary")
