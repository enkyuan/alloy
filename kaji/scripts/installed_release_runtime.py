...
def _render_typescript_consumer(
    ...
    *,
    ...
    if (
        ...
        or manifest["dependencies"].get("kaji-sdk") != "file:kaji-sdk-0.2.0-beta.8.tgz"
        or sdk_package.get("version") != "0.2.0-beta.8"
        or sdk_package.get("resolved") != "file:kaji-sdk-0.2.0-beta.8.tgz"
    ...
    comparison_sdk["version"] = "0.2.0-beta.8"
    comparison_sdk["resolved"] = "file:kaji-sdk-0.2.0-beta.8.tgz"
...
def installed_release_runtime(
    ...
    *,
    ...
    verify_arguments = (
        {}
        if artifact_contract == BETA8_RELEASE_CONTRACT
