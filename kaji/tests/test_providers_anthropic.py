...
def test_anthropic_provider_rejects_unknown_options():
    from kaji.runtime.providers.anthropic import AnthropicProvider

    with pytest.raises(TypeError, match="unexpected keyword argument"):
        cast(Any, AnthropicProvider)(api_key="explicit-key", retired_option=True)
...
@pytest.mark.asyncio
async def test_anthropic_generate_maps_rate_limits_to_provider_error():
    provider = _provider()
