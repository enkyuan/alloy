...
def test_direct_custom_store_batch_consumers_are_inventoryed() -> None:
    ...
    inventory = {
        "kaji/src/kaji/modalities/text/adapter.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        "kaji/src/kaji/runtime/sessions/manager.py": (
            ".get_events(",
            1,
            "replay_session",
        ),
        "kaji/src/kaji/runtime/sessions/projector.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        "kaji/src/kaji/infra/events/journal.py": (
            ".get_events(",
            2,
            "revalidate_stored_event",
        ),
        "kaji/src/kaji/runtime/agents/planner.py": (
            ".get_events(",
            3,
            "revalidate_stored_event",
        ),
    ...
    for source_root, pattern, suffix in (
        (repo / "kaji" / "src" / "kaji", ".get_events(", "*.py"),
