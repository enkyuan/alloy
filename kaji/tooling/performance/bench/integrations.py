...
BENCHMARK_PLATFORM = (next(parent for parent in Path(__file__).resolve().parents if (parent / "contracts").is_dir() and (parent / "packages").is_dir())) / "tooling/performance/platform.py"
