...
from kaji.tooling.performance.gate.benchmark import COMMIT_PATTERN, HASH_PATTERN, release_commit
from kaji.tooling.package.python.build import installed_release_runtime
...
GATE = (next(parent for parent in Path(__file__).resolve().parents if (parent / "contracts").is_dir() and (parent / "packages").is_dir())) / "tooling/performance/gate/soak.py"
...
EXPECTED_ARTIFACTS = {
    "python": "kaji-0.3.0a1-py3-none-any.whl",
