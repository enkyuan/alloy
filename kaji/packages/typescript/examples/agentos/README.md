...
## Why this is an example, not part of kaji-sdk

`kaji-sdk` is an infra-free, portable, dual-ESM/CJS package. agentOS is the opposite:
native, platform-gated, ESM-only, preview. Putting it behind a first-class `kaji-sdk`
