...
def test_direct_custom_store_batch_consumers_are_inventoryed() -> None:
    ...
    inventory = {
        "kaji/packages/python/src/kaji/modalities/text/adapter.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        "kaji/packages/python/src/kaji/runtime/sessions/manager.py": (
            ".get_events(",
            1,
            "replay_session",
        ),
        "kaji/packages/python/src/kaji/runtime/sessions/projector.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        "kaji/packages/python/src/kaji/infra/events/journal.py": (
            ".get_events(",
            2,
            "revalidate_stored_event",
        ),
        "kaji/packages/python/src/kaji/runtime/agents/planner.py": (
            ".get_events(",
            3,
            "revalidate_stored_event",
        ),
        "kaji/packages/python/src/kaji/runtime/agents/runtime.py": (
            ".get_events(",
            3,
            "revalidate_stored_event",
        ),
        "kaji/packages/typescript/src/events/committer.ts": (
            ".getEvents(",
            2,
            "validateStoredEvent",
        ),
        "kaji/packages/typescript/src/runtime/approval/handler.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
        "kaji/packages/typescript/src/tools/planner.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
        "kaji/packages/typescript/src/runtime/runtime.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
        "kaji/packages/typescript/src/sessions/manager.ts": (
            ".getEvents(",
            1,
            "replaySession",
        ),
        "kaji/packages/typescript/src/sessions/projector.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
    ...
    for source_root, pattern, suffix in (
        (
            repo / "kaji" / "packages" / "python" / "src" / "kaji",
            ".get_events(",
            "*.py",
        ),
        (repo / "kaji" / "packages" / "typescript" / "src", ".getEvents(", "*.ts"),
    ):
