...
- ``kaji/README.md`` -- the shared overview and Python SDK README
- ``kaji/packages/serve/README.md`` -- the reference-service README
- ``kaji/packages/typescript/README.md`` -- the TypeScript SDK README
...
def _user_facing_docs() -> list[Path]:
    paths: list[Path] = [
        ...
        REPO_ROOT / "kaji" / "packages" / "serve" / "README.md",
