...
def test_direct_custom_store_batch_consumers_are_inventoryed() -> None:
    ...
    inventory = {
        "kaji/packages/py/src/modalities/text/adapter.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        "kaji/packages/py/src/runtime/sessions/manager.py": (
            ".get_events(",
            1,
            "replay_session",
        ),
        "kaji/packages/py/src/runtime/sessions/projector.py": (
            ".get_events(",
            1,
            "revalidate_stored_event",
        ),
        ...
        "kaji/packages/ts/src/runtime/approval/handler.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
        "kaji/packages/ts/src/tools/planner.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
        ...
        "kaji/packages/ts/src/sessions/manager.ts": (
            ".getEvents(",
            1,
            "replaySession",
        ),
        "kaji/packages/ts/src/sessions/projector.ts": (
            ".getEvents(",
            1,
            "validateStoredEvent",
        ),
    ...
    for source_root, pattern, suffix in (
        (
            repo / "kaji" / "packages" / "py" / "src",
            ".get_events(",
            "*.py",
        ),
        (repo / "kaji" / "packages" / "ts" / "src", ".getEvents(", "*.ts"),
    ):
