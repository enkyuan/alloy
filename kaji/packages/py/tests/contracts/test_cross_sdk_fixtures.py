...
EXPORTER = SDK_ROOT / "tooling" / "contracts/export.py"
...
PARITY_CHECK = REPO_ROOT / "kaji" / "tooling" / "contracts/parity.py"
...
def test_python_exporter_is_byte_stable_and_covers_every_scenario() -> None:
    ...
    assert len(exported["scenarios"]) == 71
    ...
    assert snapshots["postgres-lock-key"]["result"] == {
