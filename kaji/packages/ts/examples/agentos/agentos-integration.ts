 ...
 *
 * This lives in an EXAMPLE, not in kaji itself: agentOS is a preview,
 * darwin/linux-only, ~130MB-native, ESM-only dependency, and kaji is a
 ...
 * `@kaji/agentos` package, not an export of kaji.
 *
